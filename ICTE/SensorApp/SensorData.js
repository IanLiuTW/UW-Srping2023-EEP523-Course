...
function SensorData() {
    ...
    return (
        <View>
            <Button title="Switch between Accelerometer/Gyroscope" onPress={() => {
                switch (displayData) {
                    case 'Accelerometer':
            ...
            <Text style={styles.title}>Displaying {displayData} Data:</Text>
            <Text style={styles.text}>X: {mapping[displayData].x}</Text>
            <Text style={styles.text}>Y: {mapping[displayData].y}</Text>
            <Text style={styles.text}>Z: {mapping[displayData].z}</Text>
        </View>
    );
}
